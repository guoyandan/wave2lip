...
def datagen(frames, mels):
	...
	cv2.imwrite(path.join("/home/guo/wave2lip/wave2lip_torch/Wav2Lip/results", '1.jpg'), face_det_results[0][0])
	cv2.imwrite(path.join("/home/guo/wave2lip/wave2lip_torch/Wav2Lip/results", '3.jpg'), face_det_results[3][0])
	cv2.imwrite(path.join("/home/guo/wave2lip/wave2lip_torch/Wav2Lip/results", '5.jpg'), face_det_results[5][0])
